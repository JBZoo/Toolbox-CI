...
class ConverterTeamCityTest extends PHPUnit
{
    public function testJUnit()
    {
        ...
        isSame(implode('', [
            ...
            "\n##teamcity[inspectionType id='CodingStandardIssues' name='Coding Standard Issues' category='Coding Standard' description='Issues found while checking coding standards' flowId='{$flowId}']\n",
            "\n##teamcity[inspection typeId='CodingStandardIssues' file='/Users/smetdenis/Work/projects/jbzoo-toolbox-ci/tests/ExampleTest.php' line='85' message='------------------------------------------------------------------------------------------------------------------------|nJBZoo\PHPUnit\ExampleTest / testWarning|nSome warning|n /Users/smetdenis/Work/projects/jbzoo-toolbox-ci/tests/ExampleTest.php:87' SEVERITY='WARNING' flowId='159753']\n",
    ...
    public function testJUnit2()
    {
        ...
        isSame(implode('', [
            ...
            "\n##teamcity[testFinished name='testNotice' duration='0' flowId='{$flowId}']\n",
            "\n##teamcity[testStarted name='testWarning' locationHint='php_qn://{$filepath}::\JBZoo\PHPUnit\ExampleTest::testWarning' flowId='{$flowId}']\n",
            "\n##teamcity[inspectionType id='CodingStandardIssues' name='Coding Standard Issues' category='Coding Standard' description='Issues found while checking coding standards' flowId='159753']\n",
            "\n##teamcity[inspection typeId='CodingStandardIssues' file='{$filepath}' line='80' message='------------------------------------------------------------------------------------------------------------------------|nJBZoo\PHPUnit\ExampleTest / testWarning|nSome warning|n /Users/smetdenis/Work/projects/jbzoo-toolbox-ci/tests/ExampleTest.php:82' SEVERITY='WARNING' flowId='{$flowId}']\n",
            "\n##teamcity[testFinished name='testWarning' duration='0' flowId='{$flowId}']\n",
            "\n##teamcity[testSuiteFinished name='JBZoo\PHPUnit\ExampleTest' flowId='{$flowId}']\n",
