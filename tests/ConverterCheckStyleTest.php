...
class ConverterCheckStyleTest extends PHPUnit
{
    ...
    public function testToInternalPHPcs()
    {
        ...
        isSame(implode("\n", [
            ...
            'File Path: src/JUnit/JUnitXml.php:50:1',
            'Severity : error',
            '</failure>',
            '      </testcase>',
            '    </testsuite>',
    ...
    public function testToInternalPhpStan()
    {
        ...
        isSame(implode("\n", [
            ...
            'File Path: src/JUnit/TestCaseElement.php:34:1',
            'Severity : error',
            '</failure>',
            '      </testcase>',
            ...
            'File Path: src/JUnit/TestCaseElement.php:42:1',
            'Severity : error',
            '</failure>',
            '      </testcase>',
            ...
            'File Path: src/JUnit/TestCaseElement.php:52:1',
            'Severity : error',
            '</failure>',
            '      </testcase>',
            ...
            'File Path: src/JUnit/TestCaseElement.php:54:1',
            'Severity : error',
            '</failure>',
            '      </testcase>',
            '    </testsuite>',
