...
class ConverterCheckStyleTest extends PHPUnit
{
    public function testToInternalPhan()
    {
        ...
        isSame([
            ...
            'failure'   => [
                ...
                'details' => implode("\n", [
                    ...
                    'Path: src/JUnit/JUnitXml.php:37',
                    'Severity: warning',
                    '',
                ]),
            ]
        ...
        isSame(implode("\n", [
            ...
            'Path: src/JUnit/JUnitXml.php:44',
            'Severity: warning',
            '</failure>',
            '      </testcase>',
            '    </testsuite>',
            ...
            'Path: src/JUnit/TestCaseElement.php:34',
            'Severity: warning',
            '</failure>',
            '      </testcase>',
            ...
            'Path: src/JUnit/TestCaseElement.php:36',
            'Severity: warning',
            '</failure>',
            '      </testcase>',
            ...
            'Rule: PhanPluginCanUseParamType',
            'Path: src/JUnit/TestCaseElement.php:42',
            'Severity: warning',
            '</failure>',
            '      </testcase>',
            '    </testsuite>',
            ...
            'Can use string as the type of parameter $name of setName',
            'Rule: PhanPluginCanUseParamType',
            'Path: src/JUnit/TestSuiteElement.php:35',
            'Severity: warning',
            '</failure>',
            '      </testcase>',
            ...
            'Rule: PhanPluginSuspiciousParamPositionInternal',
            'Path: src/JUnit/TestSuiteElement.php:37',
            'Severity: warning',
            '</failure>',
            '      </testcase>',
            '    </testsuite>',
    ...
    public function testToInternalPHPcs()
    {
        ...
        isSame(implode("\n", [
            ...
            'Path: src/JUnit/JUnitXml.php:24:5',
            'Severity: warning',
            '</failure>',
            '      </testcase>',
            ...
            'Path: src/JUnit/JUnitXml.php:44:35',
            'Severity: error',
            '</failure>',
            '      </testcase>',
            ...
            'Path: src/JUnit/JUnitXml.php:50:1',
            'Severity: error',
            '</failure>',
            '      </testcase>',
            '    </testsuite>',
    ...
    public function testToInternalPhpStan()
    {
        ...
        isSame(implode("\n", [
            ...
            'Path: src/JUnit/TestCaseElement.php:34:1',
            'Severity: error',
            '</failure>',
            '      </testcase>',
            ...
            'Path: src/JUnit/TestCaseElement.php:42:1',
            'Severity: error',
            '</failure>',
            '      </testcase>',
            ...
            'Path: src/JUnit/TestCaseElement.php:52:1',
            'Severity: error',
            '</failure>',
            '      </testcase>',
            ...
            'Path: src/JUnit/TestCaseElement.php:54:1',
            'Severity: error',
            '</failure>',
            '      </testcase>',
            '    </testsuite>',
    ...
    public function testToInternalPsalm()
    {
        ...
        isSame(implode("\n", [
            ...
            'Path: src/JUnit/TestCaseElement.php:34:21',
            'Severity: error',
            '</failure>',
            '      </testcase>',
            ...
            'Path: src/JUnit/TestCaseElement.php:42:21',
            'Severity: error',
            '</failure>',
            '      </testcase>',
            ...
            'Path: src/JUnit/TestCaseElement.php:52:21',
            'Severity: error',
            '</failure>',
            '      </testcase>',
            ...
            'Path: src/JUnit/TestCaseElement.php:54:37',
            'Severity: error',
            '</failure>',
            '      </testcase>',
            ...
            'Path: src/JUnit/TestCaseElement.php:65:47',
            'Severity: error',
            '</failure>',
            '      </testcase>',
            '    </testsuite>',
